...
public class PacketData implements Serializable {
	 ...
	 * @param clientData the list of clients comprising the packet data field
	 */
	public PacketData(byte version, byte mode, byte code, ArrayList<ClientData> clientData) {
